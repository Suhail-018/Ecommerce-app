      ...
      {/* filter otions */}
        <div className='min-w-60'>
          ...
          <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'}  sm:block`}> 
              <p className='mb-3 text-sm font-medium'> WEATHER TYPE</p>
              <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
                  <p className='flex gap-2'>
                    <input className='w-3' type="checkbox" value={'Warm'} onChange={toggleSubCategory}/> Warm
                  </p>
                  <p className='flex gap-2'>
                    <input className='w-3' type="checkbox" value={'Cool'} onChange={toggleSubCategory}/> Cool
                  </p>
                  <p className='flex gap-2'>
                    <input className='w-3' type="checkbox" value={'Rainy'} onChange={toggleSubCategory}/> Rainy
                  </p>
